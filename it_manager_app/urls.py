...
from it_manager_app.views import index, TaskTypeListView, TaskListView, PositionListView, WorkerListView, \
    TaskDetailView, WorkerDetailView, TaskCreateView, TaskTypeCreateView, PositionCreateView, TaskTypeDelete, TaskTypeUpdate, PositionTypeDelete, PositionTypeUpdate
